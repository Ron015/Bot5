...
```
After doing 1-5 you can copy paste all of that into a File name it: `install.sh` then execute it by typing: `./install.sh`
> You will need to type Y/J for the approvements etc.
```
